pub fn run_methodsandimplementations() 
{
    println!("---METHODS AND IMPLEMENTATIONS PRACTICE---");
    println!("
        Structs let you create custom types that are meaningful for your domain. By using structs, 
        you can keep associated pieces of data 
        connected to each other and name each piece to make your code clear. In impl blocks, 
